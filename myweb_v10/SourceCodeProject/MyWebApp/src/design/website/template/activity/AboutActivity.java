...
import design.website.template.activity.ContactUsActivity.ActionBrodcastListener;
...
/**
 * The activity to show About page
 * 
 * @author vishalbodkhe
 * 
 */
public class AboutActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			loadUrl();
			mWebView.loadUrl(AppConfig.ABOUT_URL);
			mProgressBar.setVisibility(View.VISIBLE);
		}
	...
	private void initAds() {
		...
		if (AppConfig.ADS_ENABLED) {
			AppUtils.addAdsBannerView(AboutActivity.this, mAdsView);
