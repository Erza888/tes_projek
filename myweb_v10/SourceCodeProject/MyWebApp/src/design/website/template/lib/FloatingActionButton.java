...
public class FloatingActionButton extends Button {
	...
	public FloatingActionButton(Context context, AttributeSet attributes) {
		...
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
				dpToPx(sizeIcon, getResources()), dpToPx(sizeIcon,
						getResources()));
	...
	protected void onDraw(Canvas canvas) {
		...
		if (x != -1) {
			...
			Rect dst = new Rect(dpToPx(1, getResources()), dpToPx(2,
					getResources()), getWidth() - dpToPx(1, getResources()),
					getHeight() - dpToPx(2, getResources()));
